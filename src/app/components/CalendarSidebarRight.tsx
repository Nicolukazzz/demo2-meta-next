...
interface CalendarSidebarRightProps {
    selectedDate: Date;
...
// ============================================================================
// CALENDAR SIDEBAR RIGHT COMPONENT
// Mini calendars and actions on the right side
// ============================================================================

export function CalendarSidebarRight({
    selectedDate,
    onSelectDate,
    onCreateTurn,
    canCreateTurn,
        ...
        <div className="space-y-3">
            ...
            {websiteUrl && (
                <div className="bg-white/5 rounded-lg border border-white/10 p-2.5">
                    <div className="text-[9px] uppercase tracking-wider text-slate-500 mb-1.5">Sitio Web</div>
                    <div className="text-[10px] text-slate-400 mb-2 truncate">{websiteUrl}</div>
                    <div className="flex gap-1.5">
                        <button
                            type="button"
                            className="flex-1 py-1 px-2 rounded-md border border-white/10 bg-white/5 text-[10px] text-slate-300 hover:bg-white/10 transition-colors flex items-center justify-center gap-1"
                            onClick={() => {
